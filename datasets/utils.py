...
def preprocess_dataset_config(dataset_config, stage):
    ...
    dataset_config_copy.direction = dataset_config.direction if dataset_config.__contains__('direction') else 'BtoA'
...
def transform_image(dataset_config, image, image_cond=None, flip=False):
